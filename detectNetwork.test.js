...
describe('Discover', function() {
  ...
  it('has a prefix of 6011 and a length of 19', function() {
    detectNetwork('6011222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 644 and a length of 16', function() {
    detectNetwork('6441222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 644 and a length of 19', function() {
    detectNetwork('6441222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 645 and a length of 16', function() {
    detectNetwork('6451222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 645 and a length of 19', function() {
    detectNetwork('6451222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 646 and a length of 16', function() {
    detectNetwork('6461222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 646 and a length of 19', function() {
    detectNetwork('6461222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 647 and a length of 16', function() {
    detectNetwork('6471222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 647 and a length of 19', function() {
    detectNetwork('6471222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 648 and a length of 16', function() {
    detectNetwork('6481222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 648 and a length of 19', function() {
    detectNetwork('6481222233334444555').should.equal('Discover');
  });
  
  it('has a prefix of 649 and a length of 16', function() {
    detectNetwork('6491222233334444').should.equal('Discover');
  });
  
  it('has a prefix of 649 and a length of 19', function() {
    detectNetwork('6491222233334444555').should.equal('Discover');
  });
  ...
  it('has a prefix of 65 and a length of 19', function() {
    detectNetwork('6511222233334444555').should.equal('Discover');
  });
